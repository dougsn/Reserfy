...
public class CategoriaDTOSwagger implements Serializable {
    ...
    public CategoriaDTOSwagger() {
    }

    public CategoriaDTOSwagger(String id, String qualificacao, String descricao, String urlImagem) {
        this.id = id;
